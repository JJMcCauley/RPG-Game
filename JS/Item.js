class Item {
    constructor(name, category, subcategory = null) {
        ...
        if (subcategory === 'weapons') {
            ...
            this.dmgRange = library.masterItemList[category][subcategory][name].dmgRange;
            if (library.masterItemList[category][subcategory][name].defense) {
                this.defense = library.masterItemList[category][subcategory][name].defense;
            }
            if (library.masterItemList[category][subcategory][name].evasion) {
                this.evasion = library.masterItemList[category][subcategory][name].evasion;
            }
            if (library.masterItemList[category][subcategory][name].specialEffects) {
                this.specialEffects = library.masterItemList[category][subcategory][name].specialEffects;
            }
            ...
            this.defense = library.masterItemList[category][subcategory][name].defense;
            this.evasion = library.masterItemList[category][subcategory][name].evasion;
            this.magicDefense = library.masterItemList[category][subcategory][name].magicDefense;
            if (library.masterItemList[category][subcategory][name].specialEffects) {
                this.specialEffects = library.masterItemList[category][subcategory][name].specialEffects;
            }
            this.equippable = true;
